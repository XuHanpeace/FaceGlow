...
# 文件路径
background_path = "/Users/hanksxu/Desktop/project/FaceGlow/docs/brand/icon-ios-compliant.png"
text_path = "/Users/hanksxu/Desktop/project/FaceGlow/docs/brand/icon-italic.png"
output_path = "/Users/hanksxu/Desktop/project/FaceGlow/docs/brand/icon-ios-final.png"
...
try:
    ...
    print(f"iOS规范图标合成完成: {output_path}")
